PAGE.add("Utils.CodeCoverage", function CodeCoverage (hashOfScriptsToCheck, test) {
	...
	var dog = {
		...
		, start : function(func) {
			...
			PAGE.AddExternalLib("testUtils/esprima.js", "esprima", function(esprima) {

			// adding code for code traversal, and appending the global function to add trace points
			PAGE.AddExternalLib("testUtils/esmorph.js", "esmorph", function(esmorph) {

			// add escodegen for writing new modified code
			PAGE.AddExternalLib("testUtils/escodegen.browser.js", "escodegen", function(escodegen) {
